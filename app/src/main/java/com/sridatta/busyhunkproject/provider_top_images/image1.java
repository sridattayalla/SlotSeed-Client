...
public class image1 extends Fragment implements ProviderActivity.top_images_interface{
    View v;
    ImageView imageView;
    int POSITION=0;
    String PROVIDER_UID;

    public image1 getInstance(String provider_uid){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("providers/salons/"+PROVIDER_UID+"/image_urls/url0");
    ...
    @Override
    public void onDataReceived(String provider_uid) {
        PROVIDER_UID=provider_uid;
