...
public class image2 extends Fragment {
    ...
    public image2 getInstance(String provider_uid){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("providers/salons/"+PROVIDER_UID+"/image_urls/url1");
